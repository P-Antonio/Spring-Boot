...
import com.hotel.jdbc.controler.CuentaHuespedesController;
...
public class Crear_Cuenta extends JFrame {
	...
	private JPanel btnCrear;
	private CuentaHuespedesController cuentahuespedesController;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Crear_Cuenta frame = new Crear_Cuenta();
	...
	public Crear_Cuenta() {
		...
		this.cuentahuespedesController = new CuentaHuespedesController();
		...
		imgHotel.setIcon(new ImageIcon(Crear_Cuenta.class.getResource("/imagenes/img-hotel-login-.png")));
		...
		btnCrear.setBackground(SystemColor.textHighlight);
		btnCrear.setBounds(65, 431, 122, 44);
		panel.add(btnCrear);
		...
		lblNewLabel_1.setIcon(new ImageIcon(Crear_Cuenta.class.getResource("/imagenes/lOGO-50PX.png")));
	...
	private void ListarTabla() {
		try {
			this.cuentahuespedesController.listaCuentaHuespedes();
	...
	private void SingUp() throws SQLException{
	     ...
	     Contraseña = String.valueOf(txtContrasena.getPassword());
	
	     var crearCuenta = new CuentaHuepedes(txtUsuario.getText(), Contraseña);	
	     this.cuentahuespedesController.guardarHuesped(crearCuenta);
