...
import com.hotel.jdbc.controler.ReservasController;
...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(68, 136, 204, 14);
		...
		txtValor.setBounds(68, 328, 146, 33);
		...
		btnsiguiente.setToolTipText("sigu");
		...
		btnsiguiente.setBackground(new Color(0, 0, 255));
		btnsiguiente.setBounds(207, 493, 153, 35);
		...
		lblNewLabel.setBounds(0, 0, 153, 35);
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 ...
	 private void guardarReserva(){
		 ...
		 Reserva reserva = new Reserva(java.sql.Date.valueOf(FechaE),
				 java.sql.Date.valueOf(FechaS), txtValor.getText(),txtFormaPago.getSelectedItem().toString());
		 try {
			reservasController.guardarHuesped(reserva);
	 ...
	 private void valorReserva(JDateChooser FechaE, JDateChooser FechaS) {
		 if(FechaE.getDate()!= null && FechaS.getDate() != null) {
			 Calendar fechaInicio = FechaE.getCalendar();
			 Calendar fechaFin = FechaS.getCalendar();
			 int dias = -1;
			 int cobroDiario = 30000;
			 int valor;
			 while(fechaInicio.before(fechaFin) && fechaFin.equals(fechaFin)) {
				 dias++;
				 fechaInicio.add(Calendar.DATE, 1);
			 }
		 valor = dias * cobroDiario;
