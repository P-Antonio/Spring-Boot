...
import com.hotel.jdbc.controler.HuespedesController;
...
public class RegistroHuesped extends JFrame {
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 ...
	 public void guardarHuesped(){
		 ...
		 Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(),java.sql.Date.valueOf(FechaNacimiento),
				txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(),txtNreserva.getText());

			try {
				huespedesController.guardarHuesped(huespedes);
