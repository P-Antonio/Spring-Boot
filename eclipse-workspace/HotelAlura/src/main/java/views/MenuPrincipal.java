...
public class MenuPrincipal extends JFrame{
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Pedro Leon © 2023");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				eleccion =  JOptionPane.showConfirmDialog(null,"desea salir del programa");
		...
		btnLogin.setBounds(754, 326, 83, 70);
		...
		btnlogin.setBounds(754, 258, 89, 23);
		panel.add(btnlogin);
		...
		btnSingUp.setForeground(new Color(255, 0, 0));
		btnSingUp.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 12));
		btnSingUp.setBounds(754, 292, 89, 23);
		panel.add(btnSingUp);
	}
